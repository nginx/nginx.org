...
<xsl:template name="body"><xsl:param name="lang"/>
    ...
    <div id="banner">
        ...
        <strong>NGINX Amplify is in private beta now!</strong><br/>
        Looking for a simple yet efficient monitoring tool for NGINX?<br/>
        <a href="https://www.nginx.com/amplify/?utm_source=nginxorg&amp;utm_medium=banner&amp;utm_campaign=amplify">Join our early adopters program today and try it out!</a><br/>
    </div>
