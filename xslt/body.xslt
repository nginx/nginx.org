...
<xsl:template name="body"><xsl:param name="lang"/>
    ...
    <div id="banner">
        ...
        <strong>Share your perspective on NGINX today and for the future.</strong><br/>
        <em>Take the 2015 NGINX User Survey by March 30.
        <a href="http://survey.newkind.com/r/pXmteacd" onClick="ga('send', 'event', 'banner', 'click', 'user_survey_2015');">Let your voice be heard!</a></em><br/>
    </div>
