...
<xsl:template name="body"><xsl:param name="lang"/>
    ...
    <div id="banner">
        ...
        <strong>Announcing NGINX Plus Release 9</strong><br/>
        Now with UDP load balancing, dynamic modules,<br/>
        new service discovery features, and more!
        <a href="https://www.nginx.com/blog/nginx-plus-r9-released/?utm_source=nginxorg&amp;utm_medium=banner&amp;utm_campaign=r9"><em>Explore R9!</em></a><br/>
    </div>
